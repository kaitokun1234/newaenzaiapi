...
get '/blocknum' do
  "a"
  cross_origin
  cli = Eth::Client.create "https://evm.shibuya.astar.network"
  @block_number = cli.eth_block_number
  puts "↓ぶろっくばんごー"
  puts @block_number["result"].to_i(16)
  @block_number["result"].to_i(16)
  "#{@block_number["result"].to_i(16)}"
end
...
get '/mintnum' do
  abi = '[
    {
      "inputs": [
        ...
        },
        {
          ...
          "name": "_mintLimitation",
          "type": "uint256"
        },
        {
          "internalType": "uint8",
          "name": "_newMintLimitPerBlock",
          "type": "uint8"
        }
      ],
      ...
      "inputs": [
        {
          "indexed": false,
          "internalType": "bool",
          "name": "_preIsNeedPermission",
          "type": "bool"
        },
        {
          "indexed": false,
          "internalType": "bool",
          "name": "_newIsNeedPermission",
          "type": "bool"
        }
      ],
      "name": "changedNeedPermission",
      "type": "event"
    },
    {
      "anonymous": false,
  ...
  addr = "0xED5AF388653567Af2F388E6224dC7C4b3241C544"
